...
//OutletService와  Hasing되는 Test Class...
public class ProductArrayTest4 {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("===============1.이나영 고객님이 구입한 물건들을 출력합니다.===========");
	    System.out.println(service.getBuyDetail(customers, "이나영"));
	}
}
