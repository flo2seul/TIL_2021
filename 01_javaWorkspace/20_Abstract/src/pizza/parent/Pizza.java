 ...
 * 2.반면에 여러 종류의 피자가 만들어질 수 있는 결정적인 부분은 추상 메소드로 선언해둔다...public abstract void topping();
 * 
 * 완벽한 추상성---> 인터페이스--> 사용자와 작성자간의 Contract
 * 부분적인 추상성 --> 추상 클래스 --> 결정적으로 다른 부분을 미완으로 돌려준다.--> 자식이 미완을 완성하도록 리딩.내가말
 */
public abstract class Pizza {
	...
	public void bake() {
		System.out.println("180도에서 10분간 구워냅니다...");
